...
extension PaginatedDataStatePatterns<T> on PaginatedDataState<T> {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    TResult Function(PaginatedEmpty<T> value)? empty,
    TResult Function(PaginatedFailure<T> value)? failure,
    ...
    switch (_that) {
      ...
      case PaginatedLoading() when loading != null:
        return loading(_that);
      case PaginatedSuccess() when success != null:
        return success(_that);
      case PaginatedEmpty() when empty != null:
        return empty(_that);
      case PaginatedFailure() when failure != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(PaginatedEmpty<T> value) empty,
    required TResult Function(PaginatedFailure<T> value) failure,
  }) {
    final _that = this;
    switch (_that) {
      ...
      case PaginatedLoading():
        return loading(_that);
      case PaginatedSuccess():
        return success(_that);
      case PaginatedEmpty():
        return empty(_that);
      case PaginatedFailure():
        return failure(_that);
      case _:
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(List<T> items, PaginationMetadata metadata, bool isLoadingMore)? success,
    ...
    switch (_that) {
      ...
      case PaginatedLoading() when loading != null:
        return loading();
      case PaginatedSuccess() when success != null:
        return success(_that.items, _that.metadata, _that.isLoadingMore);
      case PaginatedEmpty() when empty != null:
        return empty();
      case PaginatedFailure() when failure != null:
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<T> items, PaginationMetadata metadata, bool isLoadingMore) success,
...
class PaginatedSuccess<T> implements PaginatedDataState<T> {
  const PaginatedSuccess({required final List<T> items, required this.metadata, this.isLoadingMore = false})
      : _items = items;
  ...
  $PaginatedSuccessCopyWith<T, PaginatedSuccess<T>> get copyWith =>
      _$PaginatedSuccessCopyWithImpl<T, PaginatedSuccess<T>>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PaginatedSuccess<T> &&
...
abstract mixin class $PaginatedSuccessCopyWith<T, $Res> implements $PaginatedDataStateCopyWith<T, $Res> {
  factory $PaginatedSuccessCopyWith(PaginatedSuccess<T> value, $Res Function(PaginatedSuccess<T>) _then) =
      _$PaginatedSuccessCopyWithImpl;
  @useResult
  $Res call({List<T> items, PaginationMetadata metadata, bool isLoadingMore});

  $PaginationMetadataCopyWith<$Res> get metadata;
}

/// @nodoc
class _$PaginatedSuccessCopyWithImpl<T, $Res> implements $PaginatedSuccessCopyWith<T, $Res> {
...
class PaginatedFailure<T> implements PaginatedDataState<T> {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PaginatedFailureCopyWith<T, PaginatedFailure<T>> get copyWith =>
      _$PaginatedFailureCopyWithImpl<T, PaginatedFailure<T>>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PaginatedFailure<T> &&
...
abstract mixin class $PaginatedFailureCopyWith<T, $Res> implements $PaginatedDataStateCopyWith<T, $Res> {
  factory $PaginatedFailureCopyWith(PaginatedFailure<T> value, $Res Function(PaginatedFailure<T>) _then) =
      _$PaginatedFailureCopyWithImpl;
  @useResult
...
/// @nodoc
class _$PaginatedFailureCopyWithImpl<T, $Res> implements $PaginatedFailureCopyWith<T, $Res> {
