...
mixin _$PaginationMetadata {
 ...
 int get currentPage; int get itemsPerPage; int get totalItems; int get totalPages; bool get hasNextPage; bool get hasPrevPage;
...
@override
int get hashCode => Object.hash(runtimeType,currentPage,itemsPerPage,totalItems,totalPages,hasNextPage,hasPrevPage);
...
/// Create a copy of PaginationMetadata
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentPage = null,Object? itemsPerPage = null,Object? totalItems = null,Object? totalPages = null,Object? hasNextPage = null,Object? hasPrevPage = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int currentPage,  int itemsPerPage,  int totalItems,  int totalPages,  bool hasNextPage,  bool hasPrevPage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PaginationMetadata() when $default != null:
return $default(_that.currentPage,_that.itemsPerPage,_that.totalItems,_that.totalPages,_that.hasNextPage,_that.hasPrevPage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int currentPage,  int itemsPerPage,  int totalItems,  int totalPages,  bool hasNextPage,  bool hasPrevPage)  $default,) {final _that = this;
switch (_that) {
case _PaginationMetadata():
return $default(_that.currentPage,_that.itemsPerPage,_that.totalItems,_that.totalPages,_that.hasNextPage,_that.hasPrevPage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int currentPage,  int itemsPerPage,  int totalItems,  int totalPages,  bool hasNextPage,  bool hasPrevPage)?  $default,) {final _that = this;
switch (_that) {
case _PaginationMetadata() when $default != null:
return $default(_that.currentPage,_that.itemsPerPage,_that.totalItems,_that.totalPages,_that.hasNextPage,_that.hasPrevPage);case _:
  return null;
...
class _PaginationMetadata implements PaginationMetadata {
  const _PaginationMetadata({required this.currentPage, required this.itemsPerPage, required this.totalItems, required this.totalPages, required this.hasNextPage, required this.hasPrevPage});
...
/// Create a copy of PaginationMetadata
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? currentPage = null,Object? itemsPerPage = null,Object? totalItems = null,Object? totalPages = null,Object? hasNextPage = null,Object? hasPrevPage = null,}) {
