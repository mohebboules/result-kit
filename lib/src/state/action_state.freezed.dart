...
extension ActionStatePatterns<T> on ActionState<T> {
  ...
  TResult maybeMap<TResult extends Object?>({
    TResult Function(ActionInitial<T> value)? initial,
    TResult Function(ActionLoading<T> value)? loading,
    TResult Function(ActionSuccess<T> value)? success,
    TResult Function(ActionFailure<T> value)? failure,
    ...
    switch (_that) {
      ...
      case ActionLoading() when loading != null:
        return loading(_that);
      case ActionSuccess() when success != null:
        return success(_that);
      case ActionFailure() when failure != null:
  ...
  TResult map<TResult extends Object?>({
    required TResult Function(ActionInitial<T> value) initial,
    required TResult Function(ActionLoading<T> value) loading,
    required TResult Function(ActionSuccess<T> value) success,
    required TResult Function(ActionFailure<T> value) failure,
  }) {
    final _that = this;
    switch (_that) {
      case ActionInitial():
...
class ActionSuccess<T> implements ActionState<T> {
  ...
  $ActionSuccessCopyWith<T, ActionSuccess<T>> get copyWith =>
      _$ActionSuccessCopyWithImpl<T, ActionSuccess<T>>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ActionSuccess<T> &&
...
abstract mixin class $ActionSuccessCopyWith<T, $Res> implements $ActionStateCopyWith<T, $Res> {
  factory $ActionSuccessCopyWith(ActionSuccess<T> value, $Res Function(ActionSuccess<T>) _then) =
      _$ActionSuccessCopyWithImpl;
  @useResult
  $Res call({T? data});
}

/// @nodoc
class _$ActionSuccessCopyWithImpl<T, $Res> implements $ActionSuccessCopyWith<T, $Res> {
...
class ActionFailure<T> implements ActionState<T> {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ActionFailureCopyWith<T, ActionFailure<T>> get copyWith =>
      _$ActionFailureCopyWithImpl<T, ActionFailure<T>>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ActionFailure<T> &&
...
abstract mixin class $ActionFailureCopyWith<T, $Res> implements $ActionStateCopyWith<T, $Res> {
  factory $ActionFailureCopyWith(ActionFailure<T> value, $Res Function(ActionFailure<T>) _then) =
...
/// @nodoc
class _$ActionFailureCopyWithImpl<T, $Res> implements $ActionFailureCopyWith<T, $Res> {
